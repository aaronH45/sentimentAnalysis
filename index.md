...
<p align="center" style="max-width: 600px;"><img src="./visualizations/sentiment.jpg" alt="Sentiment Analysis"  width="640"/></p>
...
#### Model
To create our model, we used the logistic regression function provided by the sklearn library. We used 80 percent of our data to train on the model, and we used the other 20 percent to test the accuracy of our model. We ran a 5-fold cross validation algorithm on our model trained with several different regularization level. We were able to achieve the best accuracy results of 70 percent with an inverse regularization value of 0.26. 
